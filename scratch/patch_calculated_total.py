...
content = content.replace("line.calculatedTotal", "((line.quantity * line.unitPrice) - line.discount)")
...
content = content.replace("line.calculatedTotal", "(line.quantity * line.unitPrice)")
