...
content = content.replace("import '../../domain/extensions/invoice_line_extensions.dart';", "import '../../infrastructure/repositories/product_repository.dart';")
